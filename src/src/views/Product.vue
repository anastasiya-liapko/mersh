  ...
  <div class="page-product d-flex flex-column">
    <div class="container container-main d-flex flex-grow-1">
      <div class="container-inner">
        <h2 v-if="product.info.name !== ''" class="title page-product__title text-center">{{ product.info.name }}</h2>
...
import { scrollMixin, domenMixin } from '@/mixins'
