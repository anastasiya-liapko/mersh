				...
				<form method="POST">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<small>Вставьте сюда новые записи. Каждая запись на новой строчке: <b class="csv-create-format">ID, Название, Описание, Отображать в меню</b></small>
...
".(function_exists("processTD")?processTD("
		<div class='genesis-item-property '>
			...
			<div class='text-center genesis-button-container'>
				<a href='products.php?product_collections_filter_tags={$item["name"]}' class='btn btn-primary btn-genesis '>
					<span class='fa fa-cubes'></span> ".(" {$item["cnt"]}"!="0"?" {$item["cnt"]}":"")."
				</a>
			</div>
		</div>
...
".(function_exists("processTD")?processTD("<div class='genesis-item-property '>
	...
	$actions['csv_create_execute'] = function()
	{
		...
		$sql = "INSERT IGNORE INTO collections (`name`, `txt`, `display_in_menu`) VALUES (?, ?, ?)";
...
$display_in_menu = $_REQUEST['display_in_menu'];
		...
		$params = [$name, $txt, $display_in_menu];
		$sql = "INSERT INTO collections (`name`, `txt`, `display_in_menu`) VALUES (?, ?, ?)";
